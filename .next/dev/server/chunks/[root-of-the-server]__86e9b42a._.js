...
"[project]/src/server/application/use-cases/results/GetResponseStatus.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class GetResponseStatus {
    gameRepository;
    answerRepository;
    constructor(gameRepository, answerRepository){
        this.gameRepository = gameRepository;
        this.answerRepository = answerRepository;
    }
    async execute(gameId) {
        // Find game
        const game = await this.gameRepository.findById(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$value$2d$objects$2f$GameId$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GameId"](gameId));
        if (!game) {
            return {
                success: false,
                errors: {
        ...
        if (gameStatus !== '出題中' && gameStatus !== '締切') {
            return {
                ...
                errors: {
                    _form: [
                        'Game not accepting responses. Dashboard only available during answer phase.'
                    ]
                }
            };
        }
        ...
        const participants = answers.map((answer)=>({
...
"[project]/src/app/api/games/[gameId]/dashboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$results$2f$GetResponseStatus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/application/use-cases/results/GetResponseStatus.ts [app-route] (ecmascript)");
...
async function GET(_request, { params }) {
    try {
        ...
        const gameRepository = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$infrastructure$2f$repositories$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createGameRepository"])();
        const answerRepository = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$infrastructure$2f$repositories$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAnswerRepository"])();
        const useCase = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$results$2f$GetResponseStatus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GetResponseStatus"](gameRepository, answerRepository);
        ...
        if (!result.success) {
            ...
            if (errorMessage.includes('not found')) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ...
                    details: `No game with ID ${gameId}`
                }, {
                    status: 404
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86e9b42a._.js.map