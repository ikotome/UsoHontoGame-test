...
"[project]/src/components/pages/ResultsPage/index.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const ResultsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call ResultsPage() from the server but ResultsPage is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/pages/ResultsPage/index.tsx <module evaluation>", "ResultsPage");
}),
"[project]/src/components/pages/ResultsPage/index.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const ResultsPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call ResultsPage() from the server but ResultsPage is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/pages/ResultsPage/index.tsx", "ResultsPage");
}),
"[project]/src/components/pages/ResultsPage/index.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pages$2f$ResultsPage$2f$index$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/pages/ResultsPage/index.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pages$2f$ResultsPage$2f$index$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/components/pages/ResultsPage/index.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pages$2f$ResultsPage$2f$index$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/src/server/application/use-cases/results/GetResults.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    async execute(gameId) {
        ...
        if (game.status.toString() !== '締切') {
            return {
                ...
                errors: {
                    _form: [
                        "Results only available when game status is '締切'"
                    ]
                }
            };
        }
        ...
        const presenterData = await Promise.all(presenters.map(async (presenter)=>{
        ...
        const averageScore = participantScores.length > 0 ? Math.round(totalScore / participantScores.length * 10) / 10 : 0;
        // Calculate median score
        let medianScore = 0;
        if (participantScores.length > 0) {
            const sortedScores = [
                ...participantScores
            ].map((p)=>p.totalScore).sort((a, b)=>a - b);
...
"[project]/src/app/games/[id]/results/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pages$2f$ResultsPage$2f$index$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/pages/ResultsPage/index.tsx [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$results$2f$GetResults$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/application/use-cases/results/GetResults.ts [app-rsc] (ecmascript)");
...
async function Page({ params }) {
    ...
    const useCase = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$results$2f$GetResults$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GetResults"](gameRepository, answerRepository);
    const result = await useCase.execute(gameId);
    // Pass data to client component
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pages$2f$ResultsPage$2f$index$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ResultsPage"], {
        gameId: gameId,
        initialData: result.success ? result.data : undefined
    }, void 0, false, {
        fileName: "[project]/src/app/games/[id]/results/page.tsx",
        lineNumber: 33,
        columnNumber: 10
    }, this);
}
...
"[project]/src/app/games/[id]/results/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/games/[id]/results/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__24ae25cb._.js.map