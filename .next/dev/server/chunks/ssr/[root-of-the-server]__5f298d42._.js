...
"[project]/src/server/application/use-cases/games/AddEpisode.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AddEpisode {
    ...
    async execute(input) {
        ...
        if (!presenter) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$NotFoundError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NotFoundError"](`Presenter ${presenterId} not found`);
        }
        ...
        if (existingEpisodes.length >= 3) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Presenter ${presenterId} already has 3 episodes (maximum reached)`);
        }
        // Validate lie marker constraint (FR-005: exactly 1 lie episode)
        if (isLie) {
            const hasLie = existingEpisodes.some((ep)=>ep.isLie);
            if (hasLie) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Presenter ${presenterId} already has a lie episode`);
            }
        }
        // Create episode entity
        const episodeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["nanoid"])();
        const now = new Date();
        const episodeEntity = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$entities$2f$Episode$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Episode"].create({
            id: episodeId,
            presenterId,
            text: text.trim(),
            isLie,
...
"[project]/src/server/application/use-cases/games/AddPresenter.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AddPresenter {
    ...
    async execute(input) {
        ...
        if (existingPresenters.length >= 10) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Game ${gameId} already has maximum of 10 presenters`);
        }
        // Create incomplete presenter entity (episodes will be added later)
        const presenterId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanoid$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["nanoid"])();
        const now = new Date();
        const presenterEntity = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$entities$2f$Presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Presenter"].createIncomplete({
            id: presenterId,
            gameId,
...
"[project]/src/server/application/use-cases/games/AddPresenterWithEpisodes.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class AddPresenterWithEpisodes {
    gameRepository;
    constructor(gameRepository){
        this.gameRepository = gameRepository;
    }
    async execute(input) {
        ...
        if (episodes.length !== 3) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Presenter must have exactly 3 episodes (received ${episodes.length})`);
        }
        // Validate exactly 1 lie marker
        const lieCount = episodes.filter((ep)=>ep.isLie).length;
        if (lieCount !== 1) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Presenter must have exactly 1 lie episode (received ${lieCount})`);
        }
        ...
        for(let i = 0; i < episodes.length; i += 1){
            ...
            if (!episodeText || episodeText.trim().length === 0) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Episode ${i + 1}: text cannot be empty`);
            }
            if (episodeText.length > 1000) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$errors$2f$ValidationError$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ValidationError"](`Episode ${i + 1}: text cannot exceed 1000 characters (received ${episodeText.length})`);
            }
        }
        ...
        const episodeEntities = episodes.map((episodeInput)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$entities$2f$Episode$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Episode"].create({
        ...
        const presenterEntity = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$entities$2f$Presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Presenter"].create({
            id: presenterId,
            gameId,
            nickname: nickname.trim(),
...
"[project]/src/server/application/use-cases/games/RemovePresenter.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/actions/presenter.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

/* __next_internal_action_entry_do_not_use__ [{"40249f4560a8c8ef849338b84abb6fecff5d0de4f9":"addPresenterAction","405ba8948de1d50260f6347b8832da18ff6b076d5b":"addPresenterWithEpisodesAction","406f2b18621dc56a1d6fa0525cbfb43aa1653360b5":"addEpisodeAction","40f87649737539ef1320033cfc4109025bd04030c4":"removePresenterAction"},"",""] */ __turbopack_context__.s([
    "addEpisodeAction",
    ()=>addEpisodeAction,
    "addPresenterAction",
    ()=>addPresenterAction,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$AddEpisode$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/application/use-cases/games/AddEpisode.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$AddPresenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/application/use-cases/games/AddPresenter.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$AddPresenterWithEpisodes$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/application/use-cases/games/AddPresenterWithEpisodes.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$RemovePresenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/application/use-cases/games/RemovePresenter.ts [app-rsc] (ecmascript)");
...
async function addPresenterAction(formData) {
    try {
        ...
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$schemas$2f$gameSchemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AddPresenterSchema"].safeParse(rawData);
        ...
        const useCase = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$AddPresenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AddPresenter"](repository);
        const result = await useCase.execute({
            gameId: validationResult.data.gameId,
            nickname: validationResult.data.nickname
        });
        // Revalidate the presenter management page
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/game/${validationResult.data.gameId}/presenters`);
        return {
            success: true,
        ...
        return {
            ...
            errors: {
                _form: [
                    error instanceof Error ? error.message : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])('action.presenter.add.error')
                ]
            }
        };
    }
}
async function removePresenterAction(formData) {
    try {
        // Parse and validate form data
        const rawData = {
            gameId: formData.get('gameId'),
        ...
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$schemas$2f$gameSchemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RemovePresenterSchema"].safeParse(rawData);
        if (!validationResult.success) {
            return {
                success: false,
                errors: validationResult.error.flatten().fieldErrors
        ...
        // Execute use case
        const repository = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$infrastructure$2f$repositories$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createGameRepository"])();
        const useCase = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$RemovePresenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RemovePresenter"](repository);
        ...
        return {
            ...
            errors: {
                _form: [
                    error instanceof Error ? error.message : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])('action.presenter.delete.error')
                ]
            }
        };
    }
}
async function addEpisodeAction(formData) {
    try {
        // Parse and validate form data
        const rawData = {
            presenterId: formData.get('presenterId'),
        ...
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$schemas$2f$gameSchemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AddEpisodeSchema"].safeParse(rawData);
        if (!validationResult.success) {
            return {
                success: false,
                errors: validationResult.error.flatten().fieldErrors
        ...
        const useCase = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$AddEpisode$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AddEpisode"](repository);
        const result = await useCase.execute({
            presenterId: validationResult.data.presenterId,
        ...
        if (presenter) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/game/${presenter.gameId}/presenters`);
        }
        return {
            success: true,
        ...
        return {
            ...
            errors: {
                _form: [
                    error instanceof Error ? error.message : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["t"])('action.episode.add.error')
                ]
            }
        };
    }
}
async function addPresenterWithEpisodesAction(formData) {
    try {
        // Parse and validate form data
        const episodesRaw = [];
        for(let i = 0; i < 3; i += 1){
        ...
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$domain$2f$schemas$2f$gameSchemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AddPresenterWithEpisodesSchema"].safeParse(rawData);
        if (!validationResult.success) {
            return {
                success: false,
                errors: validationResult.error.flatten().fieldErrors
        ...
        // Execute use case
        const repository = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$infrastructure$2f$repositories$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createGameRepository"])();
        const useCase = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$application$2f$use$2d$cases$2f$games$2f$AddPresenterWithEpisodes$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AddPresenterWithEpisodes"](repository);
        const result = await useCase.execute({
            gameId: validationResult.data.gameId,
            nickname: validationResult.data.nickname,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(addPresenterAction, "40249f4560a8c8ef849338b84abb6fecff5d0de4f9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(removePresenterAction, "40f87649737539ef1320033cfc4109025bd04030c4", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(addEpisodeAction, "406f2b18621dc56a1d6fa0525cbfb43aa1653360b5", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(addPresenterWithEpisodesAction, "405ba8948de1d50260f6347b8832da18ff6b076d5b", null);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/.next-internal/server/app/games/[id]/presenters/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions/presenter.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/presenter.ts [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/.next-internal/server/app/games/[id]/presenters/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions/presenter.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "405ba8948de1d50260f6347b8832da18ff6b076d5b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addPresenterWithEpisodesAction"],
    "40f87649737539ef1320033cfc4109025bd04030c4",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["removePresenterAction"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$games$2f5b$id$5d2f$presenters$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/games/[id]/presenters/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/actions/presenter.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/presenter.ts [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$games$2f5b$id$5d2f$presenters$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$games$2f5b$id$5d2f$presenters$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$presenter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__5f298d42._.js.map